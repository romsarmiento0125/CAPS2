...
class CreateCustomerCancelItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_cancel_items', function (Blueprint $table) {
            $table->id();
            $table->string('email');
    ...
    {
        Schema::dropIfExists('customer_cancel_items');
    }
}
